...
export default function DashboardPage() {
    ...
    const fetchCeckResi = async (courier: string) => {
        ...
        try {
            const {data: res} = await axios(`${process.env.NEXT_PUBLIC_API_URL}/v1/track`, {
                params: {
        ...
        <ContentLayout title="Dashboard">
            ...
            <PageContainer>
                <div className="flex items-center gap-4">
                    <Input value={resi} onChange={(e) => setResi((e.target.value))} placeholder={"resi"}
                           className={"w-52"}/>
                    ...
                    <DialogContent>
                        ...
                        <div className={"space-y-2"}>
                            ...
                            <div>
                                ...
                                <Input value={courier} onChange={(e) => setCourier(e.target.value)} type="text"
                                       id="courier" placeholder={"Kurir"}/>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <Input value={asrama} onChange={(e) => setAsrama(e.target.value)} type="text"
                                       id="asrama"/>
                            </div>
                            <div>
                                <Label>Ukuran</Label>
